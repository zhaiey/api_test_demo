...
from api_test.utils.enums import RequestMethod, RequestTypeEnum
# from utils.data.models.model import TestCase
from read_cases import LoadCase
...
def case_get():
    _case_data = []
    for _num,_case in LoadCase.items():
        _case_data.append(_case)
    return _case_data

print(case_get()[0]['info'])
# print(case_get())
